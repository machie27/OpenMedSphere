...
namespace OpenMedSphere.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260314171028_AddDataShareForeignKeysAndKeyLimits")]
    partial class AddDataShareForeignKeysAndKeyLimits
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OpenMedSphere.Domain.Entities.DataShare", b =>
                {
                    ...
                    b.HasIndex("RecipientResearcherId")
                        .HasDatabaseName("IX_DataShares_RecipientResearcherId");

                    b.HasIndex("SenderResearcherId")
