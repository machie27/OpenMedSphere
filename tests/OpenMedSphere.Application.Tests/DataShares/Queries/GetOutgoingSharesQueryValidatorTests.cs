...
{
    public sealed class GetOutgoingSharesQueryValidatorTests
    {
        private readonly GetOutgoingSharesQueryValidator _validator = new();

        private static GetOutgoingSharesQuery CreateValidQuery() => new()
        {
